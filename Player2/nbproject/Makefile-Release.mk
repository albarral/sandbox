...
${OBJECTDIR}/src/sam/player/data/T3Game.o: src/sam/player/data/T3Game.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sam/player/data
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/player/data/T3Game.o src/sam/player/data/T3Game.cpp
...
${OBJECTDIR}/src/sam/player/modules/attack/Attacker.o: src/sam/player/modules/attack/Attacker.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/player/modules/attack/Attacker.o src/sam/player/modules/attack/Attacker.cpp
...
${OBJECTDIR}/src/sam/player/utils/BoardPlace.o: src/sam/player/utils/BoardPlace.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sam/player/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/player/utils/BoardPlace.o src/sam/player/utils/BoardPlace.cpp
...
${OBJECTDIR}/src/sam/player/utils/Game.o: src/sam/player/utils/Game.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sam/player/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/player/utils/Game.o src/sam/player/utils/Game.cpp
...
${OBJECTDIR}/src/sam/player/utils/GamePiece.o: src/sam/player/utils/GamePiece.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sam/player/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/player/utils/GamePiece.o src/sam/player/utils/GamePiece.cpp

${OBJECTDIR}/src/sam/player/utils/Move.o: src/sam/player/utils/Move.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sam/player/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/player/utils/Move.o src/sam/player/utils/Move.cpp
