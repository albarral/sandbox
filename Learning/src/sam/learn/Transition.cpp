...
void Transition::loadFromMemo(utilsDB::Database* pDatabase, sql::Connection* con)
{
...
void Transition::storeInMemo(utilsDB::Database* pDatabase, sql::Connection* con)
{
...
void Transition::upDateInMemo(utilsDB::Database* pDatabase)
{
...
void Transition::deleteFromMemo(utilsDB::Database* pDatabase)
{
    sql::Connection* con = pDatabase->getConnectionDB();
...
void Transition::storeQ(utilsDB::Database* pDatabase, sql::Connection* con)
{
