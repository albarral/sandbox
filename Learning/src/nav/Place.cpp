...
void Place::loadFromMemo(utilsDB::Database* pDatabase, sql::Connection* con)
{
...
void Place::storeInMemo(utilsDB::Database* pDatabase, sql::Connection* con)
{
...
void Place::upDateInMemo(utilsDB::Database* pDatabase)
{
...
void Place::deleteFromMemo(utilsDB::Database* pDatabase)
{
    sql::Connection* con = pDatabase->getConnectionDB();
...
void Place::storeQ(utilsDB::Database* pDatabase, sql::Connection* con)
{
    ...
    {
        it_connetion->storeQ(pDatabase, con);
        it_connetion++;	
    }
}

void Place::connectionsFromMemo(utilsDB::Database* pDatabase, sql::Connection* con)
{
...
void Place::loadConnections(utilsDB::Database* pDatabase, sql::Connection* con)
{
    std::vector<Connection>::iterator it_connetion = listConnections.begin();
    std::vector<Connection>::iterator it_end = listConnections.end();
    while (it_connetion != it_end)
...
void Place::storeConnections(utilsDB::Database* pDatabase, sql::Connection* con)
{
    std::vector<Connection>::iterator it_connetion = listConnections.begin();
    std::vector<Connection>::iterator it_end = listConnections.end();
    while (it_connetion != it_end)
