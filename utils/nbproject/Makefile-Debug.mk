...
${OBJECTDIR}/src/sam/utils/Console.o: src/sam/utils/Console.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/utils/Console.o src/sam/utils/Console.cpp

${OBJECTDIR}/src/sam/utils/Module.o: src/sam/utils/Module.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/sam/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/sam/utils/Module.o src/sam/utils/Module.cpp
